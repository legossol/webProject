...
public class DummyGenerator {
	...
	public String makeEmail() {
		List<String> ns = Arrays.asList("LMNOPQRSTUV".split(""));
		List<String> ns1 = Arrays.asList("ABCDEFGHIJK".split(""));
		List<String> ns2 = Arrays.asList("WXYZabcdefgh".split(""));
		List<String> ns3 = Arrays.asList("ijklmnopqrstuvwxyz".split(""));
		...
		shuffle(ns2);
		shuffle(ns3);
		return ns.get(0) +ns1.get(0) +ns2.get(0)+ns3.get(0) + ls.get(0);
	}
	
	public String makeBirthday() {
		int date = rangeRandom.apply(1,30);
		int date1 = rangeRandom.apply(1,31);
